...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AShooterGameGameModeBase_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AShooterGameGameModeBase_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AShooterGameGameModeBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AShooterGameGameModeBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AShooterGameGameModeBase, 484829744);
	template<> SHOOTERGAME_API UClass* StaticClass<AShooterGameGameModeBase>()
	{
		return AShooterGameGameModeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AShooterGameGameModeBase(Z_Construct_UClass_AShooterGameGameModeBase, &AShooterGameGameModeBase::StaticClass, TEXT("/Script/ShooterGame"), TEXT("AShooterGameGameModeBase"), false, nullptr, nullptr, nullptr);
